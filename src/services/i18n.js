...
const en = {
    ...
    settings: {
        ...
        scanningFolderPrefix: 'Scanning\u00a0',
        scanningFolderSuffix: '\u00a0for .crd files on startup',
...
const es = {
    ...
    settings: {
        ...
        scanningFolderPrefix: 'Escaneando\u00a0',
        scanningFolderSuffix: '\u00a0en busca de archivos .crd al iniciar',
...
const de = {
    ...
    settings: {
        ...
        scanningFolderPrefix: '',
        scanningFolderSuffix: '\u00a0wird beim Start nach .crd-Dateien durchsucht',
